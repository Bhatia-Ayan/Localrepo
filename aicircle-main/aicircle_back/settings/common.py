"""
Django settings for aicircle project.
...
APPS_DIR = ROOT_DIR.path("aircircle_back")
...
AUTHENTICATION_BACKENDS = [
    "users.backend.authentication_backends.EmailBackend",
    "users.backend.authentication_backends.AdminAuthProxyBackend",
]
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = "aicircle_back.urls"
...
WSGI_APPLICATION = "aicircle_back.wsgi.application"
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="support@aicircle.com")
EMAIL_USE_TLS = True
